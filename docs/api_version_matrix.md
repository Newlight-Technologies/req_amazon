...
| --- | --- | --- | --- |
| `ReqAmazon.SpApi.APlusContent` | `lib/req_amazon/sp_api/a_plus_content.ex` | `v2020-11-01` | Current wrapper; Brand Story is covered through this content-document API |
...
| `ReqAmazon.SpApi.DataKiosk` | `lib/req_amazon/sp_api/data_kiosk.ex` | `v2023-11-15` | Current wrapper, verified in tests in this pass |
...
| `ReqAmazon.SpApi.FinancesV2` | `lib/req_amazon/sp_api/finances_v2.ex` | `v2024-06-19` | Compatibility alias kept for older callers |
| `ReqAmazon.SpApi.FinancesV20240619` | `lib/req_amazon/sp_api/finances_v2024_06_19.ex` | `v2024-06-19` | Current wrapper, expanded and verified in tests in this pass |
...
| `ReqAmazon.SpApi.Sellers` | `lib/req_amazon/sp_api/sellers.ex` | `v1` | Current wrapper, verified in tests in this pass; `get_account/1` noted as EU-only |
...
| `ReqAmazon.SpApi.Uploads` | `lib/req_amazon/sp_api/uploads.ex` | `v2020-11-01` | Current wrapper; companion API for A+ image upload destinations |
